  ...
  return (
    <Navbar className="border-b-2">
      ...
      <div className="flex gap-2 md:order-2">
        ...
        <Link to="/sign-in">
          <button
            className="px-2 py-2 bg-gradient-to-r from-gray-800 via-gray-600 to-gray-400 hover:from-gray-700 hover:via-gray-500 hover:to-gray-300 rounded-lg text-white shadow-md"
            pill="true"
          >
            Sign In
          </button>
